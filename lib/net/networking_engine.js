...
shaka.net.NetworkingEngine = class extends shaka.util.FakeEventTarget {
  ...
  /**
   * Copy all request filters from a source NetworkingEngine instance
   * to this NetworkingEngine.
   *
   * @param {shaka.net.NetworkingEngine} networkingEngine
   * @export
   */
  copyRequestFilters(networkingEngine) {
    goog.asserts.assert(networkingEngine instanceof shaka.net.NetworkingEngine,
        'parameter is not a shaka.net.NetworkingEngine instance');
    for (const filter of networkingEngine.requestFilters_) {
      this.requestFilters_.add(filter);
    }
  }
  ...
  /**
   * Copy all response filters from a source NetworkingEngine instance
   * to this NetworkingEngine.
   *
   * @param {shaka.net.NetworkingEngine} networkingEngine
   * @export
   */
  copyResponseFilters(networkingEngine) {
    goog.asserts.assert(networkingEngine instanceof shaka.net.NetworkingEngine,
        'parameter is not a shaka.net.NetworkingEngine instance');
    for (const filter of networkingEngine.responseFilters_) {
      this.responseFilters_.add(filter);
    }
  }
